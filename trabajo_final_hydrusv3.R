...
#### DIRECTORIOS ####
fig_dir      <- here("figuras")         #misma carpeta de salida usada en avances anteriores
hydrus_dir   <- here("Hydrus_Avance_final")   #carpeta con los archivos de salida de HYDRUS
...
#así está en el script de post_processing
  ...
  svg(file.path(fig_dir, "dinamica_anual_comparativa_hydrus.svg"), width = 10, height = 10)
